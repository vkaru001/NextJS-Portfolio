    ...
    >
      ...
      <div className="z-10">
        ...
        <p className="text-[#ADB7BE] mb-4 max-w-md">
          ...
          reach me out on +1 305-427-1701. You can also e-mail me on <Link href="mailto:karumuruvyshnavi2000@gmail.com">karumuruvyshnavi2000@gmail.com</Link></p>
        <div className="socials flex flex-row gap-3">
          ...
          <Link href="mailto:karumuruvyshnavi2000.com">
